...
class MusicListView: UIView,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        viewContorller.currentAudioIndex = indexPath.row
        viewContorller.prepareAudio()
        viewContorller.rotationAnimation()
        viewContorller.playAudio()
        viewContorller.playButton.setImage(UIImage(named: "player_btn_pause_normal@2x.png"), forState: UIControlState.Normal)
